#include-once
;#### I modified the library to load the .dll from a \lib directory instead of the script directory
;#### ImageSearchDLL.dll => lib\ImageSearchDLL.dll
...
Func _ImageSearchArea($findImage,$resultPosition,$x1,$y1,$right,$bottom,ByRef $x, ByRef $y, $tolerance,$HBMP=0)
	...
	If IsString($findImage) Then
		...
		If $HBMP = 0 Then
			$result = DllCall("lib\ImageSearchDLL.dll","str","ImageSearch","int",$x1,"int",$y1,"int",$right,"int",$bottom,"str",$findImage)
		Else
			$result = DllCall("lib\ImageSearchDLL.dll","str","ImageSearchEx","int",$x1,"int",$y1,"int",$right,"int",$bottom,"str",$findImage,"ptr",$HBMP)
		EndIf
	Else
		$result = DllCall("lib\ImageSearchDLL.dll","str","ImageSearchExt","int",$x1,"int",$y1,"int",$right,"int",$bottom, "int",$tolerance, "ptr",$findImage,"ptr",$HBMP)
	EndIf
